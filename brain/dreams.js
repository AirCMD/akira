...
class AkiraDreams {
  ...
  composeDreamText({person,location,transform,phenomenon}){
    ...
    const special={
      nightmare:"Було тривожно, і сон поступово став схожим на кошмар.",
  ...
  answerTopic(topic){
    ...
    const variants={
      ...
      nightmare:[had("nightmare")?`Кошмар мені вже траплявся. ${had("nightmare").text}`:"Кошмари можливі, але зараз не пригадую свого конкретного. Мені цікавіше, чому мозок узяв саме такі образи, ніж шукати в них пророцтво."],
      ...
      general:["Про сон можна довго говорити: фази, кошмари, усвідомлені сни, параліч, хибні пробудження, повторювані сюжети, дивні образи на межі засинання. Там вистачає дивного й без додавання магії."]
    };
